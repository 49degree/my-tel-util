...
public class ButtonAdapter extends BaseAdapter {
    ...
    public ButtonAdapter(Context c, ArrayList<HashMap<String, Object>> appList, int resource, 
            String[] from, int[] to) {
        mAppList = appList;
        mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView != null) {
            ...
            convertView = mInflater.inflate(R.layout.pfphone_del_containeritem, null);
        ...
        if (appInfo != null) {
            ...
            holder.appIcon.setImageResource(R.drawable.pfphone_msgicon);
