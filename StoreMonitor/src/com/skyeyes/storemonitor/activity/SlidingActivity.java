...
public class SlidingActivity extends BasicActivityGroup implements SlidingActivityBase {
	 ...
	 * 
	 * @see
	 * android.support.v4.app.FragmentActivity#onSaveInstanceState(android.
	 * os.Bundle) */
