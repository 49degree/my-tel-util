...
public class SlidingActivityHelper {
	...
	/** Instantiates a new ZxlySlidingActivityHelper.
	 * 
	 * @param activity
	...
	public void onPostCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			open = savedInstanceState.getBoolean("ZxlySlidingActivityHelper.open");
			secondary = savedInstanceState.getBoolean("ZxlySlidingActivityHelper.secondary");
		} else {
			open = false;
			secondary = false;
		}
	...
	public void onSaveInstanceState(Bundle outState) {
		outState.putBoolean("ZxlySlidingActivityHelper.open", mSlidingMenu.isMenuShowing());
		outState.putBoolean("ZxlySlidingActivityHelper.secondary", mSlidingMenu.isSecondaryMenuShowing());
	}
