...
public class DelUserDialog extends Dialog implements
	...
	public DelUserDialog(Context context,UserManagerService userManagerDAO) {
		super(context);
	...
	public void displayDlg() {
		...
		setContentView(R.layout.user_manager_del_dialog);// 设置对话框的布局
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.setting_in) {
			...
			userManagerDAO.delUser(strUserNo, strUserName,messageHandler);	
