...
public class InsuUselessQueryAcvitity extends ApsaiActivity{
	...
	public void initArrayList(){
		...
		to = new int[]{R.id.apsai_sale_query_list_billno,R.id.apsai_sale_query_list_number,
				R.id.apsai_sale_query_list_operate_no,R.id.apsai_sale_query_list_operate_time};
	...
	private ApsaiPageNumOperator apsaiPageNumOperator = new ApsaiPageNumOperator(){
		...
		public void initListAdapter(int[] pageInfo){
			...
			recordAdapter = new SaleCheckListAdapter(InsuUselessQueryAcvitity.this,drinkandurinesMapList,
					R.layout.insu_useless_query_list_item,from, to);
