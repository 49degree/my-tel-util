...
public class BookBottomPannel extends JPanel {
	private static final Logger logger = Logger.getLogger(BookBottomPannel.class);
	private MediaView mediaView = null;
	
	
	public BookBottomPannel(MediaView mMediaView) {
		super();
		...
		add(sendBtn, constraints, 3, 1, 1, 1);
		add(clearBtn, constraints, 4, 1, 1, 1);
