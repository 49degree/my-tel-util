...
int avcodec_default_get_buffer(AVCodecContext *s, AVFrame *pic)
{
	...
	else
	{
        ...
        for(i=0; i<3; i++)
		{
            ...
            buf->base[i]= (unsigned char *)av_mallocz((buf->linesize[i]*h>>v_shift)+16); //FIXME 16
...
{
    AVCodecContext *avctx= (struct AVCodecContext *)av_malloc(sizeof(AVCodecContext));
...
{
    AVFrame *pic= (struct AVFrame *)av_malloc(sizeof(AVFrame));
