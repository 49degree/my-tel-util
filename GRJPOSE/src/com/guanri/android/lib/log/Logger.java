...
public class Logger {
	...
	private static String logPath = "guanri"+File.separator +"logs";
	private static String logFile = "apsai.log";
	...
	private int localLevel = Level.INFO;//定义当前对象的日志级别
	//定义一个静态类,定义日志级别   
	...
	public void debug(String logInfo){
		if(localLevel<Level.INFO){//根据日志级别判断是否需要打印
	        ...
	        System.out.println(traceInfo.toString()+":"+logInfo);
