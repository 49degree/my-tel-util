...
public class TestCase {  
    ...
    public void hello() {  
        ...
        try {  
            ...
            JedisTools.getPool().returnResource(jedis);  
        }  
    ...
    public static void testList() {  
        ...
        //果没有加ALPHA参数的话，SORT命令会尝试将所有元素转换成双精度浮点数来比较，如果无法转换则会提示错误
        System.out.println(jedis.sort("lists", new SortingParams().alpha()));
    ...
    public void testSort1() {  
        ...
        Jedis redis = JedisTools.getJedis();  
