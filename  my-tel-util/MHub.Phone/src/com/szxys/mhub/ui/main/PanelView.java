...
public class PanelView extends LinearLayout implements OnClickListener{
	...
	private MHubMainActivity mContext;
	
	public PanelView(Context context,int num) {
		super(context);
		mContext = (MHubMainActivity)context;
		LinearLayout panel = (LinearLayout) View.inflate(context, R.layout.pfphone_icon_container, null);
		for (int i=0; i<num; i++){
