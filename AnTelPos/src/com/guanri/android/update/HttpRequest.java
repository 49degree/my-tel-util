...
public class HttpRequest {
	...
	private Activity activity = null;// Activity对象

	private HttpResponse httpResponse = null;
	private JSONObject responsJSON = null;
	private String responsString = null;

	public HttpRequest(String requestUrl, Map<String, String> paramMap, Activity activity) {
	...
	private void setResponsJSON() {
		try {
			// 比较下状态码，看看是否成功
			if (this.responsJSON == null) {
				this.responsJSON = new JSONObject(this.getResponsString());
			}
		} catch (Exception e) {
			e.printStackTrace();
			try {
