 ...
 *
 */
public class TransportAttribute extends AttributeBase<String> {
	...
	public TransportAttribute(String attribute) {
		super(attribute);
		...
		++index;
//		logger.debug("value.charAt(index):"+value.charAt(index));
...
//			throw new IllegalArgumentException("Parameter block expected");
	...
	public TransportAttribute(LowerTransport transport, String... parameters) {
		super(NAME);
	...
	public String toString() {
		StringBuilder buffer = new StringBuilder(NAME).append(": ").append(
				"RTP/AVP");
