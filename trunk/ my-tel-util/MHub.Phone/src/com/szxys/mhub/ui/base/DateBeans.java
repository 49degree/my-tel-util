...
public class DateBeans
{
    ...
    static SimpleDateFormat chineseDateFormat = new SimpleDateFormat("yyyy年MM月dd");
    ...
    public DateBeans(Date date)
    {
        ...
        try
        {
            baseDate = chineseDateFormat.parse("1900年1月31");
        }
